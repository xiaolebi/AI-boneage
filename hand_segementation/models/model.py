...
class Dense_layer(nn.Module):
    def __init__(self,in_channels,growth_rate):
        ...
        self.Conv0 = nn.Conv2d(in_channels,in_channels+growth_rate,kernel_size=3,stride=1,padding=1)
...
class UNet(nn.Module):
    def __init__(self,num_classes=2):
        ...
        self.up4 = self._up_block(32,16,16)#959
...
if __name__ == '__main__':
    model = UNet()
    # x = cv2.imread('../../RSNA_boneage_dataset/boneage-test-dataset/boneage-test-dataset/4360.png')
    # x = np.array(x)
