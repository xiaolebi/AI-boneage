...
parser.add_argument('--resume',default='/content/checkpoints/resume/Assess_BoneAge_InceptionV3_9.pth.tar',type=str,metavar='PATH',help='path to latest checkpoint(default:None)')
