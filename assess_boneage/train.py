...
parser.add_argument('--lr','--learning-rate',default=0.000125,type=float,metavar='LR',help='initial learning rate') #0.000063
parser.add_argument('--drop','--dropout',default=0,type=float,metavar='Dropout',help='Dropout ratio')
parser.add_argument('--schedule',type=int,nargs='+',default=[5,10,20,40,50,70],help='Decrease learning rate at these epochs')
...
parser.add_argument('--resume',default='/content/checkpoints/resume/model_best.pth.tar',type=str,metavar='PATH',help='path to latest checkpoint(default:None)')
