...
parser.add_argument('--resume',default='/content/checkpoints/resume/model_best_inception_SE_PAM_CAM_NO_SEX.pth.tar',type=str,metavar='PATH',help='path to latest checkpoint(default:None)')#/content/checkpoints/resume/Assess_BoneAge_InceptionV3_4.pth.tar
...
handler = logging.FileHandler('/content/drive/My Drive/assess_boneage/assess_boneage/0422/20210422_NOSEX_inception_SE_PAM_CAM.log')
...
#         state['lr'] = optimizer.param_groups[0]['lr']
        ...
        if (epoch+1)%5 == 0 or test_loss<6.2:
            save_checkpoint({
                'epoch':epoch+1,
...
def save_checkpoint(state,is_best,checkpoint='checkpoint',filename='checkpoint.pth.tar'):
    ...
    if is_best:
        shutil.copyfile(filepath,os.path.join("/content/drive/My Drive/assess_boneage/assess_boneage/0422",'model_best_inception_SE_PAM_CAM_NO_SEX.pth.tar'))
