...
parser.add_argument('--lr','--learning-rate',default=0.000500,type=float,metavar='LR',help='initial learning rate') #0.000125
...
parser.add_argument('--resume',default='/content/checkpoints/resume/model_best_NO_SE.pth.tar',type=str,metavar='PATH',help='path to latest checkpoint(default:None)')#/content/checkpoints/resume/Assess_BoneAge_InceptionV3_4.pth.tar
...
handler = logging.FileHandler('/content/drive/My Drive/assess_boneage/assess_boneage/0317/20210317_NO_SE_AND_PAM_PCM.log')
...
def save_checkpoint(state,is_best,checkpoint='checkpoint',filename='checkpoint.pth.tar'):
    ...
    if is_best:
        shutil.copyfile(filepath,os.path.join("/content/drive/My Drive/assess_boneage/assess_boneage/0317",'model_best_NO_SE.pth.tar'))
