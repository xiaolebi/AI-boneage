...
parser.add_argument('--resume',default='/content/checkpoints/resume/Assess_BoneAge_InceptionV3_44.pth.tar',type=str,metavar='PATH',help='path to latest checkpoint(default:None)')
...
def save_checkpoint(state,is_best,checkpoint='checkpoint',filename='checkpoint.pth.tar'):
    ...
    if is_best:
        shutil.copyfile(filepath,os.path.join("/content/drive/My Drive/assess_boneage/assess_boneage/1214",'model_best.pth.tar'))
