...
def main():
    ...
    trainset = AgeDataset(csv_file='../RSNA_boneage_dataset/assess_dataset/train.csv',transform=transform_train,root_dir='../RSNA_boneage_dataset/assess_dataset/train')
    trainloader = data.DataLoader(trainset,batch_size=args.train_batch,shuffle=True,num_workers=args.workers)
    testset = AgeDataset(csv_file='../RSNA_boneage_dataset/assess_dataset/valid.csv',transform=transform_test,root_dir='../RSNA_boneage_dataset/assess_dataset/valid')
